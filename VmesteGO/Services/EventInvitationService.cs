...
public class EventInvitationService : IEventInvitationService
    {
        ...
        public async Task InviteUserAsync(int eventId, int receiverId, int senderId, CancellationToken cancellationToken = default)
        {
            ...
            var existingInvitation = await _invitationRepository.FirstOrDefaultAsync(existingInvitationSpec, cancellationToken);
        ...
        public async Task<List<InvitationResponse>> GetInvitationsForUserAsync(int userId, CancellationToken cancellationToken = default)
        {
            var spec = new EventInvitationsForReceiverSpec(userId);
        ...
        public async Task RespondToInvitationAsync(int invitationId, EventInvitationStatus status, int userId, CancellationToken cancellationToken = default)
        {
